...
if ( ! function_exists( 'lsx_site_title' ) ) :
	...
	function lsx_site_title() {
		?>
			<div class="logo anim after">
				<a href="<?php echo esc_url( home_url( '/' ) ); ?>">
				<?php if ( of_get_option('site-logo', get_template_directory_uri() . '/assets/images/logo.png') != '' ): ?>
					<?php  echo '<img class="site-logo anim" src="'.get_template_directory_uri() . '/assets/images/logo.png'.'" />'; ?>
				<?php endif; ?>
				</a> 
			</div>
