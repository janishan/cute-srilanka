...
function minimal_lsx_scripts() {
	...
	wp_enqueue_script( 'custom-cute-srilanka', get_stylesheet_directory_uri() . '/assets/js/cute-srilanka.js', array( 'lsx_script' ), MINIMAL_LSX_VER, true );
...
// 	Load the Custom Framework Optios Page
