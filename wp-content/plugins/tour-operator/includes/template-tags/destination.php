...
function lsx_to_region_accommodation() {
	...
	if ( post_type_exists( 'accommodation' ) && is_singular( 'destination' ) && ! lsx_to_item_has_children( get_the_ID(), 'destination' ) ) {
		$args = array(
			...
			'to'        => 'destination',
			'column'    => '3',
			'before'    => '<div class="featured-accommodation-wrapper"><div class="featured-accommodation-title-wrapper section-title-wrapper"><h2 class="featured-accommodation-title section-title">Hotels</h2><div class="featured-accommodation-slider-nav slider-nav"></div></div><div class="widget lsx-widget">',
			'after'     => '</div></div>',
		);
